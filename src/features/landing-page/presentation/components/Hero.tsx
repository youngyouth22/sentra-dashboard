            ...
            <div className="flex justify-between items-stretch lg:items-end self-stretch mt-[48px] lg:mt-[22px]">
                ...
                <div className="relative flex flex-col justify-between items-end pt-[56px] lg:pt-0">
                    ...
                    <NavLink to="/portofolio">
                        <div className="flex justify-between items-center gap-[8px] text-[#070707] text-[14px] dark:text-white cursor-pointer">SEE OUR PORTFOLIO <Icons name="arrowUpRight" className="w-5" /></div>
                    </NavLink>
                    <Typography as="div" className="lg:hidden" color="#070707" size={28} weight={500} lineHeight={24}><Typography as="span" color="#8D8D8D" size={28} weight={500} lineHeight={24} noDarkMode >3</Typography>/5</Typography>
                </div>
                <div className="flex items-end gap-[24px] w-[50%] md:w-auto">
                    <Typography as="div" className="hidden lg:inline-block" color="#070707" size={28} weight={500} lineHeight={24}><Typography as="span" color="#8D8D8D" size={28} weight={500} lineHeight={24} noDarkMode >3</Typography>/5</Typography>
                    <div>
                        <div className="flex justify-between items-start self-stretch">
                            <div>
                                <Typography color="#8D8D8D" noDarkMode>Product Design</Typography>
                                <Typography color="#070707" weight={600} className="mt-[4px]">GIVENCHY</Typography>
                            </div>
                            <Typography color="#070707">24 Feb</Typography>
                        </div>
                        <img src={Givenchy} alt="Givenchy" className="w-full md:w-[270px] rounded mt-[12px]" />
                    </div>
                </div>
            </div>
        </HeroBackground>
